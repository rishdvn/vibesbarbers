...
export default function AddAppointment({flyOverOpen, setFlyOverOpen, user}:{flyOverOpen: boolean, setFlyOverOpen: Function, user: {}}) {
              ...
              if (appDetails.service === "Haircut") {
                ...
                for (let app of barberExistingApps) {
                  if (!app.appDetails.isExtra) {
                    if (app.appDetails.appStartTime && typeof app.appDetails.appStartTime === "object") {
                                  ...
                                  <div className="relative">
                                      ...
                                      >
                                          ...
                                          <div className="select-none  font-medium inline-flex items-center gap-x-1.5 rounded-l-md px-3 py-2 bg-gray-50 text-gray-800">
                                            {appDetails.service ? appDetails.service : "Select service"}
                                          </div>
                            ...
                            >
                              ...
                              <div className="text-xs font-semibold text-gray-500 flex flex-row items-center gap-x-2 col-span-1">
                                    <input
                                      ...
                                      name="extra"
                                      id="extra"
                                      checked={appDetails.isExtra}
                                      onChange={() => setAppDetails({...appDetails, "isExtra": !appDetails.isExtra})}
                                    />
                                    Book as extra appointment
                                </div>
                            </div>
